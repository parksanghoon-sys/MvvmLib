...
namespace wpfCodeCheck.ProjectChangeTracker.Local.Services
{
    public class ClosedXmlUsedExcelParser : IExcelPaser
    {
        ...
        public ClosedXmlUsedExcelParser(IBaseService<CompareEntity> baseService)
        {
        ...
        public async Task<bool> WriteExcelAync()
        {
            await Task.Run(() =>
            {
                ...
                if (ws != null)
                {
                    ...
                    var projects = _baseService.CompareResult.CompareResults as List<CustomCodeComparer>;
                    if (projects != null)
                    {
